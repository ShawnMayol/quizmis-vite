                    ...
                    <form onSubmit={handleQuizCreation} className="w-full">
                        <div className="mb-6">
                            ...
                            <p className="text-xs text-gray-600 mt-1">
                                Title should at least be 4 characters and max 20
                                characters.
                            </p>
                        </div>
                        <div className="mb-6">
                        ...
                        <button
                            type="submit"
                            className="px-4 py-2 mt-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                        >
                            Create Quiz
                        </button>
                    </form>
